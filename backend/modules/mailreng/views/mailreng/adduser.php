...
//              'rtafdata.person_IdGvm',
            ...
            [
                ...
                'value' => function($model) {
                    return $model->rankname . '' . $model->fullName;
                }
            ],
            [
                'label' => 'Description',
                'value' => function($model) {
                    $des = $model->FirstNameEn . '   ' . $model->LastNameEn;
                    return strtolower($des);
                }
            ],
//            'FirstNameEn',
//            'LastNameEn',
//             'BirthDate',
            [
                ...
                'value' => function($model) {
                    ...
                    return Yii::$app->thaiFormatter->asDate($model->BirthDate, 'php:d-m-Y');
                }
            ],
            //'Rank',
            //'unitname.FullName',
